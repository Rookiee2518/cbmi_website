    ...
    <div className="bg-white">
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-20">
            <AnimatedSection delay={0}>
              <div className="p-8 lg:p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg transition-all duration-300">
                <Calendar className="w-8 h-8 text-[#0D1B2A] mb-6 stroke-[1px]" />
                <h3 className="text-xl lg:text-2xl mb-4">Check Expiration</h3>
                <p className="text-sm lg:text-base text-gray-500 mb-6">
                  View your current license status and renewal date
                </p>
                <button className="text-[#0D1B2A] hover:text-[#1B263B] transition-colors duration-300 text-sm lg:text-base">
                  View Details →
                </button>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <div className="p-8 lg:p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="text-xl lg:text-2xl mb-4">Update Billing</h3>
                <p className="text-sm lg:text-base text-gray-500 mb-6">
            ...
            <AnimatedSection delay={0.4}>
              <div className="p-8 lg:p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="text-xl lg:text-2xl mb-4">Auto-Renewal</h3>
                <p className="text-sm lg:text-base text-gray-500 mb-6">
      ...
      <section className="py-16 lg:py-32 px-4 lg:px-12">
        <div className="max-w-[800px] mx-auto">
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-white border border-[#E9ECEF] rounded-[6px] p-8 lg:p-12">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <button className="text-gray-500 hover:text-[#0D1B2A] transition-colors duration-300 text-sm lg:text-base">
                    Disable
                  </button>
                </div>
              </div>
          ...
          <AnimatedSection>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              <div className="bg-white border border-[#E9ECEF] rounded-[6px] p-8 lg:p-10 text-center hover:shadow-lg transition-all duration-300">
                <h3 className="text-xl lg:text-2xl mb-4 text-[#0D1B2A]">Renew Now</h3>
                <p className="text-sm lg:text-base text-gray-500 mb-6">
              ...
              <div className="bg-white border border-[#E9ECEF] rounded-[6px] p-8 lg:p-10 text-center hover:shadow-lg transition-all duration-300">
                <h3 className="text-xl lg:text-2xl mb-4 text-[#0D1B2A]">Upgrade Plan</h3>
                <p className="text-sm lg:text-base text-gray-500 mb-6">
      ...
      {/* Support Section */}
      <section className="py-16 lg:py-24 px-4 lg:px-12 bg-[#F8F9FA]">
        <div className="max-w-[1440px] mx-auto text-center">
          <AnimatedSection>
            <h2 className="text-2xl lg:text-3xl mb-6 tracking-wide">
            ...
            <Link
              to="/support"
              className="inline-block w-full sm:w-auto px-10 py-4 rounded-[6px] bg-[#0D1B2A] text-white hover:bg-[#495057] transition-all duration-300 text-center"
            >
              Contact Support
            </Link>
          </AnimatedSection>
