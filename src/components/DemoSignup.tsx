...
export function DemoSignup() {
  ...
  return (
    <div className="bg-white min-h-[80vh] py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-12">
      <div className="max-w-[600px] mx-auto">
        <AnimatePresence mode="wait">
          {step === 'form' && (
            ...
            >
              <h1 className="text-3xl sm:text-4xl lg:text-5xl text-center mb-6 lg:mb-8 tracking-wider">
                Request a Demo
              </h1>
              <p className="text-center text-sm lg:text-base text-gray-500 mb-8 lg:mb-12">
          ...
          {step === 'confirmation' && (
            ...
            >
              <h1 className="text-3xl sm:text-4xl lg:text-5xl mb-6 lg:mb-8 tracking-wider">
                Confirm Your Details
              </h1>
              <p className="text-sm lg:text-base text-gray-500 mb-8 lg:mb-12">
          ...
          {step === 'thankyou' && (
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl mb-6 tracking-wider">
                You're All Set
              </h1>
              <p className="text-base lg:text-xl text-gray-500 mb-8 lg:mb-12 max-w-md mx-auto">
