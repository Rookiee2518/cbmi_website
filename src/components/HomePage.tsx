  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-[1440px] mx-auto text-center">
          ...
          <AnimatedSection delay={0.4}>
            <div className="flex items-center justify-center gap-4">
              <Link
                to="/demo"
                className="inline-block px-10 py-4 rounded-[6px] border-2 border-[#0D1B2A] text-[#0D1B2A] hover:bg-[#0D1B2A] hover:text-white transition-all duration-300"
              >
                Start Free Trial
              </Link>
              <Link
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-3 gap-8">
            <AnimatedSection delay={0}>
              <div className="p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <Layers className="w-8 h-8 text-[#0D1B2A] mb-6 stroke-[1px]" />
                <h3 className="text-2xl mb-4">Unified Platform</h3>
            ...
            <AnimatedSection delay={0.2}>
              <div className="p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                ...
                <h3 className="text-2xl mb-4">AI + Manual</h3>
                <p className="text-gray-500">
            ...
            <AnimatedSection delay={0.4}>
              <div className="p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                ...
                <h3 className="text-2xl mb-4">Enterprise Ready</h3>
                <p className="text-gray-500">
            ...
            <AnimatedSection delay={0}>
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <div className="p-10">
                  ...
                  <h3 className="text-2xl mb-3">Surveying</h3>
            ...
            <AnimatedSection delay={0.2}>
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <div className="p-10">
                  ...
                  <h3 className="text-2xl mb-3">Stockpile</h3>
                  <p className="text-gray-500 mb-6">
            ...
            <AnimatedSection delay={0.4}>
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <div className="p-10">
                  ...
                  <h3 className="text-2xl mb-3">Monitoring</h3>
                  <p className="text-gray-500 mb-6">
            ...
            <AnimatedSection delay={0.6}>
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <div className="p-10">
                  ...
                  <h3 className="text-2xl mb-3">Compliance</h3>
                  <p className="text-gray-500 mb-6">
      ...
      <section className="py-24 px-12 bg-[#0D1B2A]">
        <div className="max-w-[1440px] mx-auto text-center">
          <AnimatedSection>
            <h2 className="text-4xl text-white mb-8 tracking-wide">
              See It in Action
            </h2>
            <Link
              to="/demo"
