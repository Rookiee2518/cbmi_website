...
export function HomePage() {
  return (
    <div className="bg-white">
      ...
      <section className="py-16 lg:py-32 px-4 lg:px-12">
        <div className="max-w-[1440px] mx-auto text-center">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-base lg:text-xl text-gray-500 mb-12">
          ...
          <AnimatedSection delay={0.4}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/demo"
                className="w-full sm:w-auto inline-block px-10 py-4 rounded-[6px] border-2 border-[#0D1B2A] text-[#0D1B2A] hover:bg-[#0D1B2A] hover:text-white transition-all duration-300 text-center"
              >
                Start Free Trial
              </Link>
              <Link
                to="/demo"
                className="w-full sm:w-auto inline-block px-10 py-4 rounded-[6px] bg-[#0D1B2A] text-white hover:bg-[#495057] transition-all duration-300 text-center"
              >
                Request Demo
              </Link>
            </div>
          ...
          <AnimatedSection delay={0.6}>
            <div className="mt-20 rounded-[8px] overflow-hidden border border-[#E9ECEF] shadow-2xl">
              <ImageWithFallback
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            <AnimatedSection delay={0}>
              <div className="p-8 lg:p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <Layers className="w-8 h-8 text-[#0D1B2A] mb-6 stroke-[1px]" />
                <h3 className="text-xl lg:text-2xl mb-4">Unified Platform</h3>
            ...
            <AnimatedSection delay={0.2}>
              <div className="p-8 lg:p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <Brain className="w-8 h-8 text-[#0D1B2A] mb-6 stroke-[1px]" />
                <h3 className="text-xl lg:text-2xl mb-4">AI + Manual</h3>
                <p className="text-sm lg:text-base text-gray-500">
            ...
            <AnimatedSection delay={0.4}>
              <div className="p-8 lg:p-12 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300 group">
                <Shield className="w-8 h-8 text-[#0D1B2A] mb-6 stroke-[1px]" />
                <h3 className="text-xl lg:text-2xl mb-4">Enterprise Ready</h3>
                <p className="text-sm lg:text-base text-gray-500">
      ...
      {/* Modules Section */}
      <section className="py-16 lg:py-32 px-4 lg:px-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-[1440px] mx-auto">
          <AnimatedSection>
            <h2 className="text-2xl lg:text-4xl text-center mb-12 lg:mb-20 tracking-wide">
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-24 px-4 lg:px-12 bg-[#0D1B2A]">
        <div className="max-w-[1440px] mx-auto text-center">
          <AnimatedSection>
            <h2 className="text-2xl lg:text-4xl text-white mb-8 tracking-wide">
              See It in Action
            </h2>
            <Link
              to="/demo"
              className="inline-block w-full sm:w-auto px-10 py-4 rounded-[6px] bg-white text-[#0D1B2A] hover:bg-[#E9ECEF] transition-all duration-300"
            >
              Request Demo
            </Link>
          </AnimatedSection>
