  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-16 lg:py-32 px-4 lg:px-12">
        <div className="max-w-[1440px] mx-auto text-center">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-base lg:text-xl text-gray-500 max-w-3xl mx-auto mb-12 lg:mb-16">
            ...
            {features.map((feature, index) => (
              <AnimatedSection key={index} delay={index * 0.1}>
                <div className="p-8 lg:p-10 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300">
                  ...
                  <h3 className="text-xl lg:text-2xl mb-4">{feature.title}</h3>
          ...
          <div className="space-y-8 lg:space-y-12">
              ...
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="p-8 lg:p-16 flex flex-col justify-center order-2 lg:order-1">
                    <h3 className="text-2xl lg:text-3xl mb-6">Real-Time 3D Visualization</h3>
                    ...
                    <div className="text-[#0D1B2A] text-sm lg:text-base">
              ...
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 lg:p-16 flex flex-col justify-center order-2">
                    <h3 className="text-2xl lg:text-3xl mb-6">AI-Powered Analysis</h3>
                    <p className="text-sm lg:text-base text-gray-500 mb-6">
            ...
            <AnimatedSection delay={0.4}>
              <div className="bg-white border border-[#E9ECEF] rounded-[8px] overflow-hidden hover:shadow-xl hover:border-[#0D1B2A]/20 transition-all duration-300">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="p-8 lg:p-16 flex flex-col justify-center order-2 lg:order-1">
                    <h3 className="text-2xl lg:text-3xl mb-6">Enterprise Collaboration</h3>
                    <p className="text-sm lg:text-base text-gray-500 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {testimonials.map((testimonial, index) => (
              <AnimatedSection key={index} delay={index * 0.15}>
                <div className="p-8 lg:p-10 bg-white border border-[#E9ECEF] rounded-[6px] hover:shadow-lg hover:border-[#0D1B2A]/20 transition-all duration-300">
                  <p className="text-sm lg:text-base text-gray-600 mb-8 italic">
                    "{testimonial.quote}"
                  </p>
                  <div>
                    <div className="text-[#0D1B2A] mb-1 text-sm lg:text-base">{testimonial.author}</div>
      ...
      <section className="py-16 lg:py-24 px-4 lg:px-12 bg-[#0D1B2A]">
        <div className="max-w-[1440px] mx-auto text-center">
          <AnimatedSection>
            <h2 className="text-2xl lg:text-4xl text-white mb-4 tracking-wide">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/demo"
                className="w-full sm:w-auto inline-block px-10 py-4 rounded-[6px] border-2 border-white text-white hover:bg-white hover:text-[#0D1B2A] transition-all duration-300 text-center"
              >
                Start 7-Day Free Trial
              </Link>
              <Link
                to="/demo"
                className="w-full sm:w-auto inline-block px-10 py-4 rounded-[6px] bg-white text-[#0D1B2A] hover:bg-[#E9ECEF] transition-all duration-300 text-center"
              >
                Request Demo
              </Link>
            </div>
